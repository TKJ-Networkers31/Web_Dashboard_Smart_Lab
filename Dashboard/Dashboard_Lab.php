            ...
            <ul class="nav nav-secondary">
              <li class="nav-item active">
                ...
                <div class="collapse" id="dashboard">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="Dashboard_Lab_1.html">
                        <span class="sub-item">Dashboard Lab 1</span>
                      </a>
                    </li>
                    <li>
                      <a href="Dashboard_Lab_2.html">
                        <span class="sub-item">Dashboard Lab 2</span>
                      </a>
                    </li>
                    <li>
                      <a href="Dashboard_Lab_3.html">
                        <span class="sub-item">Dashboard Lab 3</span>
                      </a>
                    </li>
                    <li>
                      <a href="Dashboard_Lab_4.html">
                        <span class="sub-item">Dashboard Lab 4</span>
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="forms">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="../forms/add_user.html">
                        <span class="sub-item">Tambah User</span>
                      </a>
                    </li>
                    <li>
                      <a href="../forms/Login_page.html">
                  ...
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      ...
                      <div class="collapse" id="subnav1">
                        <ul class="nav nav-collapse subnav">
                          <li>
                            <a href="../Database/Log_Login/Log_login_Lab1.html">
                              <span class="sub-item">Lab 1</span>
                            </a>
                          </li>
                          <li>
                            <a href="../Database/Log_Login/Log_login_Lab2.html">
                              <span class="sub-item">Lab 2</span>
                            </a>
                          </li>
                          <li>
                            <a href="../Database/Log_Login/Log_login_Lab3.html">
                              <span class="sub-item">Lab 3</span>
                            </a>
                          </li>
                          <li>
                            <a href="../Database/Log_Login/Log_login_Lab4.html">
                              <span class="sub-item">Lab 4</span>
                            </a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <li>
                      ...
                      <div class="collapse" id="subnav2">
                        <ul class="nav nav-collapse subnav">
                          <li>
                            <a href="../Database/Log_sensor_lab/Log_Login_Lab1.html">
                              <span class="sub-item">Lab 1</span>
                            </a>
                          </li>
                          <li>
                            <a href="../Database/Log_sensor_lab/Log_Login_Lab2.html">
                              <span class="sub-item">Lab 2</span>
                            </a>
                          </li>
                          <li>
                            <a href="../Database/Log_sensor_lab/Log_Login_Lab3.html">
                              <span class="sub-item">Lab 3</span>
                            </a>
                          </li>
                          <li>
                            <a href="../Database/Log_sensor_lab/Log_Login_Lab4.html">
                              <span class="sub-item">Lab 4</span>
                            </a>
                          </li>
                        </ul>
      ...
      <div class="main-panel">
        <div class="main-header">
          <div class="main-header-logo">
            <!-- Logo Header -->
            <div class="logo-header" data-background-color="dark">
              <a href="starter-template.html" class="logo">
                <img
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <a class="dropdown-item" href="../profiles/profile.html">My Profile</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="account_setting.html">Account Setting</a>
                        <div class="dropdown-divider"></div>
